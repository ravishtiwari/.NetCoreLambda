...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *OpenApiNetCore*):
...
Execute unit tests
```
    cd "OpenApiNetCore/test/OpenApiNetCore.Tests"
    dotnet test
```

Deploy application
```
    cd "OpenApiNetCore/src/OpenApiNetCore"
